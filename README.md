...
2. **Clone the repository with submodules:**
   ```bash
   git clone --recurse-submodules https://github.com/Ziha0-Zhang/MGR
   ```
...
To train models with MGR using the grounded reasoning approach:
...
model_id = "ziha0-zhang/MGR-20-Qwen2.5-VL-3B"  # or your local checkpoint path
...
# Format prompt with MGR thinking structure
prompt_suffix = (
...
model_path = "ziha0-zhang/MGR-20-InternVL-2B"  # or path to your fine-tuned MGR model
